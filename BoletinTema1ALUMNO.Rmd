...
#Primera visión del conjunto de datos de mammals(m)
dim(m)
head(m)
tail(m)
str(m)

#Primera visión del conjunto de datos de Animals2(a)
...
#c)
#Mostramos los nombres de las filas y de las columnas
#Primero mostraremos las de mammals

rownames(m)
colnames(m)

#Seguidamente las de Animals2(a)
...
diferentes_m <- setdiff(rownames(m), rownames(a))
diferentes_m


#Animales en Animals2 pero no en mammals
diferentes_a <- setdiff(rownames(a), rownames(m))
diferentes_a
...
#El número de librerías instaladas son 636
